        ...
        for sample in train_loader:
            ...
            if config['mode'] == 'Triplet':
                ...
                sample_dict = {
                    ...
                    'p': sample['p_crop'][0].to(device),
                    'n': sample['n_crop'][0].to(device),
                    'mc': sample['main_cam'].to(device),
                    'sc': sample['sec_cam'].to(device)
                }
                ...
                sample_dict = {
                    ...
                    'mc': sample['main_cam'].to(device),
                    'sc': sample['sec_cam'].to(device),
                    'pos_a': sample['a_bbox'][0].to(device),
                    'pos_p': sample['p_bbox'][0].to(device),
                    'pos_n': sample['n_bbox'][0].to(device),
                }
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_label_pathname', required=False)
